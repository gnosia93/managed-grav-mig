...
```
watch bin/kafka-topics.sh --describe --topic grav-mig-topic --bootstrap-server b-2.mskgrav.58jn2t.c4.kafka.ap-northeast-2.amazonaws.com:9092,b-1.mskgrav.58jn2t.c4.kafka.ap-northeast-2.amazonaws.com:9092,b-3.mskgrav.58jn2t.c4.kafka.ap-northeast-2.amazonaws.com:9092
```
