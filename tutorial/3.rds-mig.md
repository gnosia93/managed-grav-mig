...
do
   sleep 1
   WRITER_IDENTIFIER=$(aws rds describe-db-clusters | jq '.DBClusters[] | select(.DBClusterIdentifier=="grav-aurora-cluster") | .DBClusterMembers[] | select(.IsClusterWriter==true).DBInstanceIdentifier')
